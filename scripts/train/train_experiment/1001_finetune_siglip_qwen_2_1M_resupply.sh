LLM_VERSION="/gpfs/public/research/jiawei/ckpt/1001_sft_llava_qwen_2_1M_bs_1_rewrite/checkpoint-10000"
...
MID_RUN_NAME="1001_resupply_200K"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1001_resupply_200K.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1001_sft_llava_qwen_2_1M_bs_1_resupply" \
    --num_train_epochs 1 \
