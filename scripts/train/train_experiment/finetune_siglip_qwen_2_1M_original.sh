...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0919_sampled_data_1M_original.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/0919_sft_llava_qwen_2_1M_bs_2_original" \
    --num_train_epochs 1 \
