...
BASE_RUN_NAME="1022_fintune_siglip_qwen_2_2M_onevision"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1022_onevision.yaml \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1022_sft_llava_qwen_2_05b_2M_bs_2_onevision" \
    --num_train_epochs 1 \
