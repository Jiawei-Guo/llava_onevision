...
BASE_RUN_NAME="1105_ablation_after_hall"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1105_ablation_after_hallucinatory.json \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1105_ablation_after_hall \
    --num_train_epochs 1 \
