...
MID_RUN_NAME="1003_sft_llava_qwen_2_8M_bs_1_rewrite"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1003_sampled_data_3.3M_rewrite.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1003_sft_llava_qwen_2_8M_bs_1_rewrite" \
    --num_train_epochs 1 \
