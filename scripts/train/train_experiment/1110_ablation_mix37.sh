...
BASE_RUN_NAME="1110_ablation_mix37"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1110_mix37.yaml \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1110_ablation_mix37 \
    --num_train_epochs 1 \
