LLM_VERSION="/gpfs/public/01/models/hf_models/llava-onevision-qwen2-0.5b-mid-stage-a4"
...
MID_RUN_NAME="1022_finetune_siglip_qwen_2_1M_rewrite"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1012_one_vision_data/single_image_1M.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1022_sft_llava_qwen_2_05b_1M_bs_2_rewrite" \
    --num_train_epochs 1 \
