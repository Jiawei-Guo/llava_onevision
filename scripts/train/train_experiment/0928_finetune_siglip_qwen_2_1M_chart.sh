...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0928_16K_chartqa.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/0928_sft_llava_qwen_2_1M_bs_2_chart" \
    --num_train_epochs 20 \
