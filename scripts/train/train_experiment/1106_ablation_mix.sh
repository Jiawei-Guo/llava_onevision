...
BASE_RUN_NAME="1106_ablation_mix"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1106_mix.yaml \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1106_ablation_mix \
    --num_train_epochs 1 \
