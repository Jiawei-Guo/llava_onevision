...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1102_onevision.yaml \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1102_1003_ov" \
    --num_train_epochs 1 \
