LLM_VERSION="/gpfs/public/research/junpeng/checkpoints/0919_llavanext_siglip_qwen2_webdata_v0.7_and_v0.8_sampling_7M_further"
LLM_VERSION_CLEAN="${LLM_VERSION//\//_}"
VISION_MODEL_VERSION="google/siglip-so400m-patch14-384"
VISION_MODEL_VERSION_CLEAN="${VISION_MODEL_VERSION//\//_}"
# 1008_sft_llava_qwen_2_1M_bs_1_original
...
MID_RUN_NAME="1004_sft_llava_qwen_2_1M_bs_1_rewrite"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1004_sampled_data_1M_rewrite.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1004_sft_llava_qwen_2_1M_bs_1_rewrite" \
    --num_train_epochs 1 \
