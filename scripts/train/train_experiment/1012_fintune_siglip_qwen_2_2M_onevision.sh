LLM_VERSION="/gpfs/public/research/jiawei/ckpt/1003_sft_llava_qwen_2_3M_bs_1_rewrite"
...
BASE_RUN_NAME="1012_fintune_siglip_qwen_2_2M_onevision"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1012_onevision.yaml \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1012_sft_llava_qwen_2_2M_bs_1_onevision" \
    --num_train_epochs 1 \
