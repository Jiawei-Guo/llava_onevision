...
MID_RUN_NAME="1018_finetune_siglip_qwen_2_200K_ocr_rewrite"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1018_all_data_200k_ocr_after_throwout.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1018_sft_llava_qwen_2_200K_bs_1_ocr_rewrite" \
    --num_train_epochs 2 \
