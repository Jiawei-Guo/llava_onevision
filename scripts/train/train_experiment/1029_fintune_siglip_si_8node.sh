...
BASE_RUN_NAME="1029_fintune_siglip_si_8"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1029_single_image.yaml \
    --image_folder /gpfs/public/research/jiawei/visual_web_inst/image/all_images \
    --pretrain_mm_mlp_adapter="/gpfs/public/research/jiawei/ckpt/1028_pretrain_siglip/mm_projector.bin" \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1029_fintune_siglip_si_1_8node \
    --num_train_epochs 1 \
