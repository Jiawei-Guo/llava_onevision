...
MID_RUN_NAME="1008_sft_llava_qwen_2_1M_bs_1_original"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1008_all_data_3.3M_rewrite.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1008_sft_llava_qwen_2_1M_bs_1_original" \
    --num_train_epochs 1 \
