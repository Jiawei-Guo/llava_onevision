...
BASE_RUN_NAME="1106_ablation_before_hall"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1106_ablation_before_hallucinatory.json \
    --image_folder /gpfs/public/research/jiawei/visual_web_inst/image/all_images \
    --pretrain_mm_mlp_adapter="/gpfs/public/research/jiawei/ckpt/1103_pretrain_siglip_1_5b/mm_projector.bin" \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1106_ablation_before_hall \
    --num_train_epochs 1 \
