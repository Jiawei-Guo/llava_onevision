LLM_VERSION="/gpfs/public/research/jiawei/ckpt/1110_fintune_siglip_qwen_ov"
...
BASE_RUN_NAME="1112_fintune_siglip_ov_futher"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/LLaVA-NeXT/scripts/train/1112_onevision_further.yaml \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/1112_fintune_siglip_ov_futher" \
    --num_train_epochs 1 \
