...
LLM_VERSION="/gpfs/public/research/jiawei/ckpt/0919_sft_llava_qwen_2_1M_bs_2_rewrite"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0922_sampled_data_200k_rewrite.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/0922_sft_llava_qwen_2_200K_bs_2_rewrite_further" \
    --num_train_epochs 1 \
