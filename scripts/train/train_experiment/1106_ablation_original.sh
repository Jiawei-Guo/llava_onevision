...
BASE_RUN_NAME="1106_ablation_original"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/1106_ablation_original_1M.json \
    ...
    --output_dir /gpfs/public/research/jiawei/ckpt/1106_ablation_original \
    --num_train_epochs 1 \
