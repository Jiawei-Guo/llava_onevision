...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0927_147K_chart.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/0927_sft_llava_qwen_2_1M_bs_2_chart_rewrite" \
    --num_train_epochs 20 \
