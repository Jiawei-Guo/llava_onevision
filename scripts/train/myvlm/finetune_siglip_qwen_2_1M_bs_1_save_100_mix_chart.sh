...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mix_rewrite_reserve_chart"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0916_single_data_1M_mix_rewrite_reserve_chart.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/sft_llava_qwen_2_1M_bs_1_0917_mix_chart" \
    --num_train_epochs 1 \
