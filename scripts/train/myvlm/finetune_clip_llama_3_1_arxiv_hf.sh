...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /xpfs/public/gezhang/Arxiv_Processed/llava_training_data_sharegpt/arxiv_qa.json \
    --image_folder /gpfs/public/research/xy/arxiv_hf \
    ...
    --output_dir "/xpfs/public/research/jiawei/LLaVA-NeXT/ckpt/sft_llava_llama_3_1_arxiv_hf" \
    --num_train_epochs 1 \
