...
LLM_VERSION="/gpfs/public/research/jiawei/sft_qwen_2_8M_checkpoint_2000"
...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-bs-2-8M-blip558k_pretrain_plain_la_1_6mix_ft"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0913_data_7M_split.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/sft_llava_qwen_2_8M_bs_2" \
    --num_train_epochs 1 \
