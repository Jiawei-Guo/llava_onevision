...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/final_sampled_data_1M_rewrite.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/sft_llava_qwen_2_1M_rewrite" \
    --num_train_epochs 1 \
