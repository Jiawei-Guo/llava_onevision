...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --pretrain_mm_mlp_adapter="/xpfs/public/research/jiawei/LLaVA-NeXT/ckpt/pretrain_llama3/mm_projector.bin" \
    ...
    --output_dir "/xpfs/public/research/jiawei/LLaVA-NeXT/ckpt/sft_llama_3_665k" \
    --num_train_epochs 1 \
