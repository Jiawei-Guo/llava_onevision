...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 --nnodes $NNODES \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/image/all_images/LLaVA-OneVision-Data/all_data.json \
    --image_folder /gpfs/public/research/jiawei/visual_web_inst/image/all_images/LLaVA-OneVision-Data \
    ...
    --output_dir "/xpfs/public/research/jiawei/LLaVA-NeXT/ckpt/sft_llava_llama_3_1_3_2M" \
    --num_train_epochs 1 \
