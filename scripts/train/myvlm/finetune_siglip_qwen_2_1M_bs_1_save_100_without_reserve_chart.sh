...
# /gpfs/public/research/jiawei/sft_qwen_2_8M_checkpoint_2000

LLM_VERSION="/gpfs/public/research/models/llava-onevision-qwen2-0.5b-mid-stage-a4"
...
source /gpfs/public/research/old_miniconda3/bin/activate llava_next
...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-without_reserve_chart"
...
torchrun --nproc_per_node $GPUS_PER_NODE \
 ...
 llava/train/train_mem.py \
    ...
    --data_path /gpfs/public/research/jiawei/visual_web_inst/0916_single_data_1M_without_reserve_chart.json \
    ...
    --output_dir "/gpfs/public/research/jiawei/ckpt/sft_llava_qwen_2_1M_bs_1_0917_without_reserve_chart" \
    --num_train_epochs 1 \
